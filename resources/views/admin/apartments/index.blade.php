        ...
        <thead>
            ...
            <tr class="text-center">
                <th scope="col" class="text-center text-white brd-left"><i
                    ...
                    <th scope="col" class="text-white text-center"><i class="fa-solid fa-tag me-2  icon-border"></i>Appartamento</th>
                    <th scope="col" class="text-white d-none d-md-table-cell"><i class="fa-solid fa-location-dot  me-2  icon-border"></i>Indirizzo
                    </th>
                    <th scope="col" class="text-white d-none d-xl-table-cell"> <i class="fa-solid fa-expand me-2 icon-border"></i>mq<sup>2</sup>
                    </th>
                    <th scope="col" class="text-white d-none d-xl-table-cell"><i class="fa-solid fa-coins  icon-border"></i>/notte</th>
                    ...
                    <td class="align-middle">
                        <div class="d-flex justify-content-center gap-2">
                            ...
                            <a href="{{ route('apartments.show', $apartment->id) }}" class="btn btn-primary"><i
                                ...
                                <!--Bottone modifica-->
                                <a class="btn btn-warning d-none d-xl-inline" href="{{ route('apartments.edit', $apartment->id) }}"><i
