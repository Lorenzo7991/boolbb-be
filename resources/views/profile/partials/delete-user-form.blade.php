<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Una volta che avrai cancellato il tuo account, tutti i dati ad esso collegati andranno persi. Prima di cancellare il tuo account, si prega di conservare tutti i dati che si intende conservare.') }}
        </p>
    </header>
